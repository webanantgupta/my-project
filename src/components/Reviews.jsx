...
const Reviews = () => {
    return <section id="review" className="scroll-mt-36 mt-5 mb-5 pl-5 pr-5">
        <div>
            <h4 className="text-4xl text-center text-indigo-800 font-semibold mt-15">Loved By Customers</h4>
            <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 mt-5 gap-6">
