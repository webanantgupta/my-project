    ...
    return <section id="about" className="about_container">
        <div className="about_element flex gap-4 ">
            <div className="about_content basis-2/4 pr-2">
                ...
                <h4 className="text-2xl font-medium text-indigo-800 mb-2">Overview</h4>
