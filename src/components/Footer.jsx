            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 pt-2">
                ...
                <div className=" basis-2/6">
                    ...
                    <ul className="grid grid-cols-2 gap-6 mt-10 ml-10">
                        ...
                        <li className="text-start cursor-pointer"><Link to="/term">Terms and Conditions</Link></li>
                        <li className="text-start  cursor-pointer"><a href="#highlight">Property Highlights</a></li>
                        <li className="text-start  cursor-pointer"><Link to="/privacy">Privacy Policy</Link></li>
                    </ul>
                </div>
                <div className=" basis-2/6">
